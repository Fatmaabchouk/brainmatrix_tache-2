      ...
      <div className='modal-container'>
        <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px ] rounded shadow-md ' >
          ...
          <form className='px-4' >
            ...
            <div>
              <button className='hover:shadow-md round-md bg-[#6a64f1] hover:bg-orange-600
               py-3 px-8 text-base font-semibold ' >Login</button>
            </div>

          </form>
          {/* model close btn */}
          <button onClick={onClose} className='bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounde inline-flex items-center mt-5 '>
            close
          </button>
